                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr>
                            ...
                            <td class="px-6 py-4 ">
                                <img src="{{ asset('assets/images/products/baju_hitam.jpg') }}"
                                    class="w-16 h-16 rounded-md" alt="">
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">LiveHaf</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Hitam</td>

                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Baju</td>
