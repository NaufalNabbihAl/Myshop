<x-layoutAdmin>
    <div class="flex-1 ml-16 p-8 transition-all duration-300 ease-in-out">
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-1">Manage your product base</p>
        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($products as $p)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $p->image }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $p->name }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $p->warna }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $p->stok }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $p->harga }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $p->ukuran }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $p->category->name }}
                                </td>

                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                    <a href="{{ route('admin.category.edit', $p->id) }}"
                                        class="text-indigo-600 hover:text-indigo-900 mr-2">Edit</a>
                                    <form id="deleteForm" action="{{ route('admin.category.destroy', $p->id) }}"
