        ...
        <div
            ...
            <div class="p-8 space-y-8">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-3xl font-extrabold text-gray-800 tracking-tight">Update Category</h2>
                ...
                <form id="categoryForm" action="{{ route('admin.category.update', $category->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    <div class="relative">
                        <input type="text" id="name" name="name" 
                            ...
                            placeholder="Name" required autocomplete="none" value="{{ $category->name }}">
                        <label for="name"
